...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/cardregisterform.css') }}">
    {{--<script src="{{ asset('js/politespace.js') }}"></script>--}}
    {{--<script src="{{ asset('js/politespace-init.js') }}"></script>--}}
        ...
        <div class="content">
            <form action="{{ route('card.store') }}" method="post">
                ...
                <dl>
                    ...
                    <dd>
                        <input id="credit" type="text" class="inputForm input_inp1" name="cardNum" value="{{ old('cardNum') }}" placeholder="半角数字"><br>
                ...
                <div class="btnSpace">
                    <button type="button" class="btn back" onclick="location.href='{{ route('card') }}'">戻る</button>
