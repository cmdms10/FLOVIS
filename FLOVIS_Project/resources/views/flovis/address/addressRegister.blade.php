...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/addressRegister.css') }}">
</head>
...
<main>
    ...
    <div id="contents" class="center">
        <form action="{{ route('address.confirm') }}" method="post" id="signupForm" class="form">
        @csrf
        ...
        <!-- 住所 -->
            <dl>
                ...
                <dd>
                    ...
                    {{-- 市区町村 --}}
                    <div>
                        <input type="text" class="input_form input_inp13" name="local21" placeholder="市区町村" value="{{ old('local21') }}" required>
                    ...
                    {{-- それ以降 --}}
                    <div>
                        <input type="text" class="input_form input_inp10" name="addr21" placeholder="それ以降の住所" value="{{ old('addr21') }}" required>
                ...
                <dd class="dd_right_bottom">
                    <input type="text" name="tel" class="input_form input_inp11" value="{{ old('tel') }}"
                           placeholder="ハイフンなし" required><br>
            ...
            <div class="btn_space form">
                ...
                <button type="button" class="btn backbtn" onclick="history.back();">戻る</button>

                <button type="submit" class="btn nextbtn">登録へ進む</button>
